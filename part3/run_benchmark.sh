...
CLIENT_AGENT_A_COMMANDS="nohup ./memcache-perf-dynamic/mcperf -T 2 -A > /dev/null 2>&1 & echo \$! > mcperf.pid"
CLIENT_AGENT_B_COMMANDS="nohup ./memcache-perf-dynamic/mcperf -T 4 -A > /dev/null 2>&1 & echo \$! > mcperf.pid"
