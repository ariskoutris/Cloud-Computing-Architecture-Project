...
def create_figures():
    ...
    for i in range(3):
        ...
        plt_95p.plot(start, result_mem["p95"], alpha=0.8, label='p95', color = 'tab:purple', zorder = 99)
        ...
        plt_cpu.plot(start, cores, alpha=0.8, label='cores', color = 'tab:red', zorder = 99)
